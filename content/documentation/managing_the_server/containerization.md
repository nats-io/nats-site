...
+++ date = "2015-09-27" title = "Containerizing the NATS Server" description = "" category = "server" \[menu.main\] name = "Containerization" weight = 8 identifier = "doc-containerization" parent = "Managing the Server" +++
...
See the [NATS Docker tutorial](https://github.com/nats-io/nats-site/tree/c42c46a7c6b8669e66e28419887d2f8dd29aa502/documentation/additional_documentation/nats-server-docker/README.md) for more instructions on using the NATS server Docker image.
