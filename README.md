...
- `npm install`
- Go to [https://github.com/gohugoio/hugo/releases/tag/v0.159.1][] and download the extended version of `hugo`. This is the version specified in the [netlify.toml][] file.
