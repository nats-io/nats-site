...
- /whats_new
```
To update content, only the .md files should be used. The .html files in the repo [nats-io/nats.docs](https://github.com/nats-io/nats.docs/) are auto-generated by gitbook when building the book.
